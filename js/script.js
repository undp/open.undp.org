...
$(function() {
    ...
    String.prototype.toTitleCase = function () {
  	...
  	.replace(/BOM/Ofc of Asst Administrator/g, 'Bureau of Management')
  	.replace(/Bratislava Regional Center/g, 'Regional Centre in Bratislava')
  	.replace(/Cameroon, Republic of/g, 'Cameroon')
  	.replace(/Congo/g, 'Republic of Congo')
  	.replace(/Democr People's Repub of Korea/g, 'Korea, Democratic People's Republic of')
