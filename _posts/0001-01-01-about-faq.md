...
A. In a few cases, units need to project expenditures before allocating the budget for a specified activity. These accounting entries are often adjusted during the budget revision. And in some cases, projects are managed at a different level. Country Offices may also use other funding sources for different activities, for instance UNDP activities carried out by United Nations Volunteers’ fund.
