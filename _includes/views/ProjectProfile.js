views.ProjectProfile = Backbone.View.extend({
    ...
    contracts: function(id) {
    	...
    	google.load("visualization", "1", {packages:["table"], 'callback': function(){
        	...
        	var datasource = '18YCDgTLUPLj5TVfUAstd_Xp8bmroAyZHxTgrZdeR';//'11kcbplG1JKQj5iM0nYghFCbgeTJyc_94Qteu8jo9';//'1pLlPUc6Wzqo2u5Xy3PvdODuJgCCp4wJaopWUy99o'; // ID of the Fusion Table we are pulling data from
