views.Donors = Backbone.View.extend({
    ...
    initialize: function() {
        ...
        this.total = new TotalModalities();
        this.donor = new DonorModalities();

        this.total.on('sync', this.render,this);
    ...
    donorGraphs: function(donor) {
        ...
        var totalData = this.total.toJSON()[0],
            donorData = this.donor.toJSON()[0];
