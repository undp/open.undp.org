  ...
  merge(Spinner.prototype, {
    ...
    lines: function(el, o) {
      ...
      for (; i < o.lines; i++) {
        ...
        if (o.shadow) ins(seg, css(fill('#888', '0 0 4px ' + '#888'), {
          top: 2 + 'px'
        }))
  ...
  (function() {
    ...
    if (!vendor(s, 'transform') && s.adj) {
      ...
      Spinner.prototype.lines = function(el, o) {
        ...
        seg(i, -2, 'progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.1)')
